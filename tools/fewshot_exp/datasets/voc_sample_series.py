...
dataset07 = PascalVOCDataset('/home/hl/hl/ourMetaWithoutFPN/datasets/voc/VOC2007', 'trainval')
dataset12 = PascalVOCDataset('/home/hl/hl/ourMetaWithoutFPN/datasets/voc/VOC2012', 'trainval')
...
for series in range(1, 2):
    ...
    with open('/home/hl/hl/ourMetaWithoutFPN/datasets/voc/VOC2007/ImageSets/Main/trainval_%dshot_novel_standard.txt'%(shot), 'w+') as f:
        for i in pick:
            if i < len(dataset07):
                f.write(dataset07.ids[i] + '\n')
    with open('/home/hl/hl/ourMetaWithoutFPN/datasets/voc/VOC2012/ImageSets/Main/trainval_%dshot_novel_standard.txt'%(shot), 'w+') as f:
        for i in pick:
            if i >= len(dataset07):
