...
import os, shutil
import sys
# crop the object from original image and save them in original shape save object under categorized folders.
...
datadirs = ['/home/hl/hl/ourMetaWithoutFPN/datasets/voc/VOC2007', '/home/hl/hl/ourMetaWithoutFPN/datasets/voc/VOC2012']

ff = int(10)

splits = ['trainval_%sshot_novel_standard' % (ff), 'trainval_%sshot_novel_standard' % (ff)]
