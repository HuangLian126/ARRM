...
class FastRCNNLossComputation(object):
    ...
    def prepare_targets(self, proposals, targets):
        ...
        for proposals_per_image, targets_per_image in zip(proposals, targets):
            ...
            matched_idxs_t = matched_idxs.clone()
            matched_idxs_t[matched_idxs_t >= 0] += targetcount
            targetcount += len(targets_per_image)
            matched.append(matched_idxs_t)
        ...
        return labels, regression_targets, matched
    ...
    def subsample(self, proposals, targets):
        ...
        for labels_per_image, regression_targets_per_image, proposals_per_image, matched_idxs_per_image in zip(labels, regression_targets, proposals, matched_idxs):
    ...
    def __call__(self, class_logits, box_regression):
        ...
        proposals = self._proposals  # [512, 4]
