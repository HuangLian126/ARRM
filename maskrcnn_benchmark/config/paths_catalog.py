...
class DatasetCatalog(object):
    ...
    DATASETS = {
        ...
        "voc_2007_trainval_1shot_closeup_standard": {
            "data_dir": "voc/VOC2007",
            "split": "1shot_voc_standard"
        },

        "voc_2007_trainval_2shot_closeup_standard": {
            "data_dir": "voc/VOC2007",
            "split": "2shot_voc_standard"
        },

        "voc_2007_trainval_3shot_closeup_standard": {
            "data_dir": "voc/VOC2007",
            "split": "3shot_voc_standard"
        },

        "voc_2007_trainval_5shot_closeup_standard": {
            "data_dir": "voc/VOC2007",
            "split": "5shot_voc_standard"
        },

        "voc_2007_trainval_10shot_closeup_standard": {
            "data_dir": "voc/VOC2007",
            "split": "10shot_voc_standard"
        },
        ...
        "voc_2012_trainval_1shot_closeup_standard": {
            "data_dir": "voc/VOC2012",
            "split": "1shot_voc_standard"
        },

        "voc_2012_trainval_2shot_closeup_standard": {
            "data_dir": "voc/VOC2012",
            "split": "2shot_voc_standard"
        },

        "voc_2012_trainval_3shot_closeup_standard": {
            "data_dir": "voc/VOC2012",
            "split": "3shot_voc_standard"
        },

        "voc_2012_trainval_5shot_closeup_standard": {
            "data_dir": "voc/VOC2012",
            "split": "5shot_voc_standard"
        },

        "voc_2012_trainval_10shot_closeup_standard": {
            "data_dir": "voc/VOC2012",
            "split": "10shot_voc_standard"
        },
    ...
    def get(name):
        if "closeup" in name:
            ...
            return dict(factory="CloseupDataset", args=args)
