...
class CloseupDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.oneOrTwo == 16:
            ...
            sup_targets = torch.LongTensor([int(0), int(1), int(2), int(3), int(4), int(5), int(6), int(7), int(8), int(9), int(10), int(11),
                 int(12), int(13), int(14),], device=imgs[0].device)

            return imgs, sup_targets
        else:
            ff0 = self.idsxxx[index][0]
            ff1 = self.idsxxx[index][1]
            ff2 = self.idsxxx[index][2]
            ...
            sup_targets = torch.LongTensor([int(0), int(1), int(2), int(3), int(4),
                                       int(5), int(6), int(7), int(8), int(9),
                                       int(10), int(11), int(12), int(13), int(14),
                                       int(15), int(16), int(17), int(18), int(19),], device=imgs[0].device)
